...
// =========================================
// Per-map context panel (Floating)
// =========================================
const MAP_CONTEXTS = {
    ...
    1: {
        ...
        chapters: ['מלכים א ד׳–ה׳', 'מלכים א ח׳ סה'],
        summary: `שימו לב כי יש להבדיל בין פסוקים המתארים את גבולות ההתיישבות של עם ישראל, לבין פסוקים המתארים את תחומי השליטה וההשפעה של שלמה על הממלכות הרבות שבאזור.

גבול התיישבותם של ישראל מתואר בביטוי המוכר: 'מדן ועד באר שבע'. דן מסמלת את נקודת היישוב הצפונית, ובאר שבע את נקודת היישוב הדרומית, לפני המדבר. הביטוי 'מדן ועד באר שבע' מופיע גם בספר שמואל (שמ״א ג', כ; י"ז, יא).

במפה מסומן תחום השליטה הרחב של ממלכת שלמה. על פי הכתוב, כל הממלכות מעברו המערבי של נהר פרת היו מעלים לשלמה מנחה ומסים. ביטויים אלו מלמדים שמדובר בימי השיא של ממלכת ישראל.`,
        verses: [
            ...
            { text: 'וַיַּעַשׂ שְׁלֹמֹה בָּעֵת הַהִיא אֶת הֶחָג וְכָל יִשְׂרָאֵל עִמּוֹ קָהָל גָּדוֹל מִלְּבוֹא חֲמָת עַד נַחַל מִצְרָיִם', ref: 'מלכים א ח\', סה' },
    ...
    2: {
        ...
        summary: 'שלמה בנה שלוש ערים מרכזיות — חצור, מגידו וגזר — בשל מיקומן האסטרטגי על "דרך הים". גזר ניתנה לשלמה כשי ממלך מצרים עם נישואיו לבת פרעה.',
        verses: [
    ...
    3: {
        ...
        chapters: ['מלכים א ג\' א', 'מלכים א י\' כח–כט'],
        summary: 'שלמה ניהל קשרי מסחר ענפים, במיוחד ביבוא סוסים ממצרים לארם והחתים. נישואיו לבת פרעה חיזקו את הברית המדינית והגבול הדרומי.',
        verses: [
    ...
    4: {
        color: '#8e44ad',
        emoji: '⚖️',
        title: 'המלכת רחבעם בשכם',
        chapters: ['מלכים א י"ב א–ה'],
        summary: 'לאחר מות שלמה, יצא העם להמליך את רחבעם בשכם. ירבעם חזר ממצרים והעם דרש הקלה במיסים. תשובתו הקשה של רחבעם הובילה לפילוג הממלכה.',
        verses: [
    ...
    5: {
        ...
        emoji: '🗺️',
        title: 'פילוג הממלכה',
        chapters: ['מלכים א י"ב'],
        summary: 'הממלכה התפצלה ליהודה (דרום) וישראל (צפון). פילוג זה החליש את העם אל מול המעצמות השכנות.',
        verses: []
    },
    6: {
        color: '#e74c3c',
        ...
        summary: 'ירבעם הקים עגלי זהב בדן ובבית אל כדי למנוע מהעם לעלות לירושלים, דבר שיצר נתק דתי בין הממלכות.',
        verses: [
            { text: 'וַיָּשֶׂם אֶת הָאֶחָד בְּבית אל וְאֶת הָאֶחָד נָתַן בְּדָן', ref: 'מלכים א י"ב, כט' }
        ]
    },
    7: {
        color: '#d35400',
        emoji: '🗡️',
        title: 'חורבן הצפון ע"י ארם',
        chapters: ['מלכים א ט"ו כ'],
        summary: 'בן הדד מלך ארם כבש את ערי הגבול הצפוניות: עיון, דן ואבל בית מעכה, ופגע קשות בנחלת נפתלי.',
        verses: [
            { text: 'וַיַּךְ אֶת עִיּוֹן וְאֶת דָּן וְאֵת אָבֵל בֵּית מַעֲכָה וְאֵת כָּל כִּנְרֹת', ref: 'מלכים א ט"ו, כ' }
        ]
    },
    8: {
        color: '#27ae60',
        emoji: '🏗️',
        title: 'בירות ממלכת ישראל',
        chapters: ['מלכים א ט"ו–ט"ז'],
        summary: 'הבירה נדדה בין שכם, תרצה ופנואל עד שייצבה עמרי בשומרון.',
        verses: []
    },
    9: {
        color: '#3498db',
        emoji: '🦅',
        title: 'אליהו והבצורת',
        chapters: ['מלכים א י"ז'],
        summary: 'אליהו הכריז על בצורת והסתתר בנחל כרית ובצרפת, שם חולל ניסים להצלת האלמנה ובנה.',
        verses: []
    },
    10: {
        color: '#2ecc71',
        emoji: '🔥',
        title: 'הכרמל',
        chapters: ['מלכים א י"ח'],
        summary: 'מעמד הר הכרמל בו הוכיח אליהו כי ה׳ הוא האלוהים מול נביאי הבעל והאשרה.',
        verses: []
    },
    11: {
        color: '#795548',
        ...
        title: 'מסעות אליהו',
        chapters: ['מלכים א'],
        summary: 'אליהו פעל בכל רחבי הארץ, מגלעד ועד חורב.',
        verses: []
    },
    12: {
        color: '#c0392b',
        emoji: '⚔️',
        title: 'ארם - יריב ושותף',
        chapters: ['מלכים א'],
        summary: 'ארם הייתה הכוח המשמעותי מצפון-מזרח שאיים על ישראל ויהודה.',
        verses: []
    },
    13: {
        color: '#c0392b',
        ...
        title: 'רמות גלעד',
        chapters: ['מלכים ב ח'],
        summary: 'עיר גבול שגרמה למלחמות רבות בין ישראל לארם.',
        verses: []
    },
    14: {
        color: '#f1c40f',
        emoji: '🌟',
        title: 'השיא של שתי הממלכות',
        chapters: ['מלכים ב י"ד–ט"ו'],
        summary: 'בימי ירבעם השני ועזריה הגיעו הממלכות להישגים טריטוריאליים הדומים לימי שלמה.',
        verses: []
    },
    15: {
        color: '#2c3e50',
        emoji: '🏹',
        title: 'אשור - האימפריה',
        chapters: ['מלכים ב ט"ו'],
        summary: 'הכוח ששינה את פני המזרח הקדום והוביל לחורבן ישראל.',
        verses: []
    },
    16: {
        color: '#c0392b',
        ...
        summary: 'אשור כבשה את הגליל והגלתה את תושביו — השלב הראשון של הגלות.',
        verses: [
            { text: 'וַיִּקַּח אֶת-עִיּוֹן וְאֶת-אָבֵל בֵּית-מַעֲכָה... וַיַּגְלֵם אַשּׁוּרָה', ref: 'מלכים ב ט"ו, כט' }
        ]
    },
    17: {
        color: '#e74c3c',
        emoji: '⛓️',
        title: 'גלות שומרון',
        chapters: ['מלכים ב י"ז'],
        summary: 'נפילת שומרון והגליית עשרת השבטים — סופה של ממלכת ישראל.',
        verses: []
    },
    18: {
        color: '#c0392b',
        emoji: '🏹',
        title: 'יאשיהו במגידו',
        chapters: ['מלכים ב כ"ג'],
        summary: 'מות יאשיהו במגידו בניסיון לעצור את פרעה נכה — נקודת מפנה ביהודה.',
        verses: []
    },
    19: {
        color: '#2c3e50',
        emoji: '🏛️',
        title: 'חורבן ירושלים ע"י בבל',
        chapters: ['מלכים ב כ"ה'],
        summary: 'נפילת יהודה והגליית בבל בשנת 586 לפנה"ס.',
        verses: []
    }
};
...
function toggleInfoPanel(forceState = null) {
    ...
    if (forceState === 'show') {
        ...
        if (window.innerWidth <= 768) {
            ...
            if (panel.classList.contains('active')) panel.classList.remove('hidden');
        } else {
            // Toggle desktop minimized
...
function renderMapContext(mapObj) {
    const container = document.getElementById('floating-info-panel');
    ...
    // Populate panel
    container.innerHTML = `
        <div class="info-header" style="background: ${ctx.color}" onclick="toggleInfoPanel()">
            <span style="font-size:1.3rem">${ctx.emoji}</span>
            <span>${ctx.title}</span>
            <span class="minimize-icon">▾</span>
        </div>
        <div class="info-body">
            <div class="ctx-chapters">
                ${ctx.chapters.map(ch => `<span class="ctx-chapter-tag">📖 ${ch}</span>`).join('')}
            </div>
            <p class="ctx-summary">${ctx.summary}</p>
            ${ctx.verses.map(v => `
                <div class="ctx-verse" style="border-right-color: ${ctx.color}">
                    "${v.text}"
                    <cite>${v.ref}</cite>
                </div>
            `).join('')}
    ...
    // Default Desktop: Minimized
    if (window.innerWidth > 768) {
        container.classList.add('minimized');
        container.classList.remove('active');
    } else {
        // Default Mobile: Hidden panel, only button visible
        container.classList.remove('active');
    }
}
